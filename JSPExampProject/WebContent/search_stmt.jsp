...
<%
	...
	String sql = "Select * from memberinfo where memberID='"+memid+"'and memberpw='"+pw+"'";
	ResultSet rs = st.executeQuery(sql);

	if(rs.next()){ //검색된 결과가 존재하면 true
		%>	
	<div id="footer">
            <a href="after_login.jsp?memid=<%=memid%>">로그인되었습니다.</a>
    </div>	
		<%
	}else{
		%>
	<div id="footer">
	<a href="login_form.html">잘못 입력되었습니다.</a>
    </div>	
		<%
	}
	rs.close();
